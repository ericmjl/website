...
def _():
    ...
    #     [
    #         lmb.user(
    #             "Calculate the salary-to-budget ratio for each department and identify employees whose salaries are above or below the department average, considering when each department was established. Return for me as a pandas dataframe, and also return the code that you wrote to make it happen." # noqa: E501
    #         )
    #     ]
    # )
    # result
...
def _(mo, model):
    starter_prompts = [
        "Compare the average salary per employee against the total department budget. Which departments are most cost-efficient in terms of salary spending relative to their budget?",  # noqa: E501
        "Analyze employee performance scores by office type (Open Office, Creative Space, etc.). Create a visualization showing how different work environments correlate with performance.",  # noqa: E501
        "Show me which department managers oversee the highest-performing remote workers. Include the manager name, department location, and average performance score of their remote team members.",  # noqa: E501
        "Calculate the salary-to-budget ratio for each department and identify employees whose salaries are above or below the department average, considering when each department was established.",  # noqa: E501
    ]
